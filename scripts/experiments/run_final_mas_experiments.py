...
async def run_qwen_25_7b_instruct_1m_with_nomic(
    ...
    await FinalMASRunner.run_via_vllm_with_huggingface_simple_rag(
        ...
        investigator_main_llm_base_url=r'http://127.0.0.1:8976/v1/chat/completions',
        ...
        investigator_formatter_llm_base_url=r'http://127.0.0.1:8976/v1/chat/completions',
        ...
        analyst_main_llm_base_url=r'http://127.0.0.1:8976/v1/chat/completions',
        ...
        analyst_formatter_llm_base_url=r'http://127.0.0.1:8976/v1/chat/completions',
