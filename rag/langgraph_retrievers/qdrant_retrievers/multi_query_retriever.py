...
from rag.document_processing.document_transformer import DocumentTransformer
...
if TYPE_CHECKING:
    from rag.embedding.qdrant_embedding_interfaces.qdrant_text_embedding_model_interface import (
