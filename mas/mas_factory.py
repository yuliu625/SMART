    ...
    def create_final_mas_via_vllm(
        ...
        graph = GraphFactory.create_final_mas_graph(
            ...
            investigator_main_llm=LocalLLMFactory.create_openai_llm(
                base_url=investigator_main_llm_base_url,
            ...
            investigator_formatter_llm=LocalLLMFactory.create_openai_llm(
                base_url=investigator_formatter_llm_base_url,
            ...
            analyst_main_llm=LocalLLMFactory.create_openai_llm(
                base_url=analyst_main_llm_base_url,
            ...
            analyst_formatter_llm=LocalLLMFactory.create_openai_llm(
                base_url=analyst_formatter_llm_base_url,
