...
class CharacterLengthDistributionPlots:
    @staticmethod
    def make_character_length_distribution_plot(
        ...
        figure.add_trace(go.Box(
            y=st_companies_df['character_length'],
        ...
        # Control Group
        figure.add_trace(go.Box(
            y=matching_sample_df['character_length'],
            name='Control Group',
            marker_color='#EF553B',
            boxmean=True,
        ))
