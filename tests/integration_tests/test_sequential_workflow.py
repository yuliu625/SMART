...
class TestSequentialMASState:
    ...
    @pytest.mark.parametrize(
        "surveyor_main_llm_model_name, surveyor_main_llm_system_message_template_path, adjudicator_main_llm_model_name, adjudicator_main_llm_system_message_template_path, adjudicator_formatter_llm_model_name, adjudicator_formatter_llm_system_message_template_path, rag, markdown_file_path, general_query_path, result_path", [
        ('qwen2.5:1.5b',
         r'D:\document\code\paper\SMART\mas\prompts\final_mas\surveyor_main_llm_system_prompt_template.j2',
         'qwen2.5:1.5b',
         r'D:\document\code\paper\SMART\mas\prompts\final_mas\adjudicator_main_llm_system_prompt_template.j2',
         ...
         r"D:\document\code\paper\SMART\mas\prompts\rag\general_query_human_prompt_template.j2",
         r"D:\dataset\smart\tests\sequential_workflow_000004.json",
         ),
        # ('qwen2.5:1.5b',
        #  r'D:\document\code\paper\SMART\mas\prompts\final_mas\surveyor_main_llm_system_prompt_template.j2',
        #  'qwen2.5:1.5b',
