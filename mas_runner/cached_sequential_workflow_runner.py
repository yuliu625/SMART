...
class CachedSequentialWorkflowRunner:
    @staticmethod
    async def run_cached_sequential_workflow_with_simple_rag(
        # IO
        ...
        for surveyor_cache_path in surveyor_cache_path_list:
            ...
            if not result_file_path.exists():
                await CachedSequentialWorkflowRunner.single_run_cached_sequential_workflow_with_simple_rag(
                    # IO
    ...
    async def run_sequential_workflow_with_multi_query_rag(
        ...
        for surveyor_cache_path in surveyor_cache_path_list:
            ...
            if not vector_store_path.exists():
                ...
                continue
            if not result_file_path.exists():
                await CachedSequentialWorkflowRunner.single_run_cached_sequential_workflow_with_multi_query_rag(
                    # IO
                    surveyor_cache_path=surveyor_cache_path,
                    general_query_path=general_query_path,
                    vector_store_path=vector_store_path,
    ...
    @staticmethod
    async def single_run_cached_sequential_workflow_with_simple_rag(
        # IO
        ...
        try:
            # build simple_rag
            simple_rag = QdrantRAGFactory.create_simple_rag(
    ...
    @staticmethod
    async def single_run_cached_sequential_workflow_with_multi_query_rag(
        # IO
        surveyor_cache_path: str | Path,
        general_query_path: str | Path,
        vector_store_path: str | Path,
        ...
        try:
            # build multi_query_rag
            multi_query_rag = QdrantRAGFactory.create_multi_query_rag(
                client_disk_path=vector_store_path,
                collection_name=collection_name,
                embedding_model_name_or_path=embedding_model_name_or_path,
                batch_size=batch_size,
    ...
    @staticmethod
    async def batch_run_cached_sequential_workflow_with_simple_rag(
        # Runtime
        max_concurrent: int,
        # IO
        surveyor_cache_dir: str | Path,
        ...
        for surveyor_cache_path in surveyor_cache_path_list:
            ...
            if not result_file_path.exists():
                tasks.append(
                    semaphore_wrapper(
                        semaphore=semaphore,
                        func=CachedSequentialWorkflowRunner.single_run_cached_sequential_workflow_with_simple_rag,
                        # IO
                        surveyor_cache_path=surveyor_cache_path,
                        general_query_path=general_query_path,
                        vector_store_path=vector_store_path,
    ...
    @staticmethod
    async def batch_run_cached_sequential_workflow_with_multi_query_rag(
        # Runtime
        max_concurrent: int,
        # IO
        surveyor_cache_dir: str | Path,
            ...
            if not result_file_path.exists():
                tasks.append(
                    semaphore_wrapper(
                        # Runtime
                        semaphore=semaphore,
                        func=CachedSequentialWorkflowRunner.single_run_cached_sequential_workflow_with_multi_query_rag,
                        # IO
                        surveyor_cache_path=surveyor_cache_path,
                        general_query_path=general_query_path,
                        vector_store_path=vector_store_path,
